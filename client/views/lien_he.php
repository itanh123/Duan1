    ...
    <div class="container">
        <div class="contact-section">
            <div class="contact-info">
                ...
                <div class="contact-item">
                    <h3>💬 Messenger</h3>
                    <p>Liên hệ với chúng tôi qua Messenger để được hỗ trợ nhanh chóng</p>
                    <a href="https://m.me/haianh.vu.92317121" target="_blank" class="messenger-link" title="Liên hệ Messenger">
                        <svg class="messenger-icon" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M12 0C5.373 0 0 4.925 0 11c0 2.134.694 4.11 1.87 5.73L0 24l7.803-2.104c1.063.29 2.188.44 3.197.44 6.627 0 12-4.925 12-11S18.627 0 12 0zm.797 18.305c-1.062 0-2.1-.15-3.048-.44l-.22-.062-2.28.614.61-2.223-.07-.22c-.93-.94-1.424-2.15-1.424-3.45 0-3.893 3.582-7.05 8-7.05s8 3.157 8 7.05-3.582 7.05-8 7.05z"/>
                        </svg>
